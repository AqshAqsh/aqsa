                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.room.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="room_no" class="form-control" id="exampleInputUserroom_no2"
                                    placeholder="Enter Room No" value="{{ $room->room_no }}">
                                @error('room_no')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="room_category_id" id="" class="form-control">
                                    ...
                                    <option value="{{ $category->id }}" <?php echo ($category->id == $room->room_category_id) ? 'selected' : ''; ?>>
                                        {{ $category->name }}
                                    </option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="description" id="" cols="30" rows="10" class="form-control">{{ $room->description }}</textarea>
                                @error('description')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="room_charge" class="form-control" id="exampleInputUserroom_charge2"
                                    placeholder="Enter Room Charge" value="{{ $room->room_charge }}">
                                @error('room_charge')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
