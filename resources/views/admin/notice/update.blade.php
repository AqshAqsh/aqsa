                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.notice.update',['id'=>$notices->id]) }}" enctype="multipart/form-data"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="title" class="form-control" id="exampleInputUsertitle2"
                                        placeholder="Enter Title" value="{{ $notices->title }}">
                                    @error('title')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" name="date" class="form-control" id="exampleInputUserdate2"
                                        placeholder="Enter Date" value="{{ $notices->date }}">
                                    @error('date')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="content" id="" cols="30" rows="10" class="form-control">{{ $notices->content }}</textarea>
                                    @error('content')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
